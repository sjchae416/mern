...
export default function Edit() {
	...
	async function onSubmit(e) {
		...
		// NOTE this will send a post request to update the data in the database
	...
	// NOTE this following section will display the form that takes input from the user to update the data.
	return (
		<div>
			<h3>Update Record</h3>
